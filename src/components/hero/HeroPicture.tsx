...
const HeroPicture = () => {
  return (
    <svg viewBox="875.074 354.117 733.851 503.767" className={styles.heroPicture}>
      <g id="Group_16" data-name="Group 16" transform="matrix(1, 0, 0, 1, 678.550598, 189.02948)">
        <path
          id="Path_204"
          data-name="Path 204"
